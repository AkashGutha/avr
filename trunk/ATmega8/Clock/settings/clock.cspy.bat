...
"C:\Program Files\IAR Systems\Embedded Workbench 5.0 KickStart\common\bin\cspybat" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 KickStart\avr\bin\avrproc.dll" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 KickStart\avr\bin\avrsim.dll"  %1 --plugin "C:\Program Files\IAR Systems\Embedded Workbench 5.0 KickStart\avr\bin\<libsupport_plugin>" --backend -B "--cpu=m8" "--enhanced_core" "-p" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 KickStart\avr\Config\iom8.ddf" "--eeprom_size" "512" "-d" "sim" 
